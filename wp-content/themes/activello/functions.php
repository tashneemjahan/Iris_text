...
if ( ! function_exists( 'activello_widgets_init' ) ) {
  function activello_widgets_init() {
    ...
    register_sidebar( array(
      'name'          => esc_html__( 'About Us', 'activello' ),
      'id'            => 'sidebar-2',
      'before_widget' => '<aside id="%1$s" class="widget %2$s">',
      'after_widget'  => '</aside>',
      'before_title'  => '<h3 class="widget-title">',
	...
	add_action( 'widgets_init', 'sidebar-2' );
	
	 register_sidebar( array(
      'name'          => esc_html__( 'Quick links', 'activello' ),
      'id'            => 'sidebar-3',
      'before_widget' => '<aside id="%1$s" class="widget %2$s">',
      'after_widget'  => '</aside>',
      'before_title'  => '<h3 class="widget-title">',
	...
	add_action( 'widgets_init', 'sidebar-3' );
	
	 register_sidebar( array(
      'name'          => esc_html__( 'Blog post', 'activello' ),
      'id'            => 'sidebar-4',
      'before_widget' => '<aside id="%1$s" class="widget %2$s">',
      'after_widget'  => '</aside>',
      'before_title'  => '<h3 class="widget-title">',
	...
	add_action( 'widgets_init', 'sidebar-4' );
	
	 register_sidebar( array(
      'name'          => esc_html__( 'Contact', 'activello' ),
      'id'            => 'sidebar-5',
      'before_widget' => '<aside id="%1$s" class="widget %2$s">',
      'after_widget'  => '</aside>',
      'before_title'  => '<h3 class="widget-title">',
	...
	add_action( 'widgets_init', 'sidebar-5' );
